...
import * as tdex_v1_transport_pb from './transport_pb';
...
export class TransportClient {
  ...
  ): Promise<tdex_v1_transport_pb.SupportedContentTypesReply>;

  supportedContentTypes(
    request: tdex_v1_transport_pb.SupportedContentTypesRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: tdex_v1_transport_pb.SupportedContentTypesReply) => void
  ): grpcWeb.ClientReadableStream<tdex_v1_transport_pb.SupportedContentTypesReply>;
  ...
  supportedContentTypes(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/tdex.v1.Transport/SupportedContentTypes',
        request,
        metadata || {},
